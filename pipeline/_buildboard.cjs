...
function renderRail(){
 ...
 var ytBox=yt&&yt.url?'<div style="background:#fff;border:1px solid var(--line);border-radius:14px;padding:14px 16px">'
  ...
  +'</a></div>':'';
 var LNK=function(color,tag,label,time,url){return '<a href="'+url+'" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border-radius:9px;border:1px solid var(--line);background:#faf9f6;color:#1a1a1a;font-size:12.5px;font-weight:600;text-decoration:none"><span style="flex:none;width:42px;text-align:center;font-size:9.5px;font-weight:800;color:#fff;background:'+color+';border-radius:4px;padding:3px 2px;line-height:1.25">'+tag+'</span><span style="flex:1;min-width:0">'+label+' <span style="color:var(--sub);font-weight:500">· '+time+'</span></span><span style="flex:none;color:var(--sub)">→</span></a>';};
 var surveyBox='<div style="background:#fff;border:1px solid var(--line);border-radius:14px;padding:14px 16px"><div style="display:flex;align-items:center;gap:7px;margin-bottom:10px"><span style="width:6px;height:6px;border-radius:50%;background:#0289A4"></span><h3 style="margin:0;font-weight:700;font-size:13px">지금 하실 수 있는 일 4가지</h3></div><img data-img="img/poster_survey4.png" src="img/poster_survey4.png" alt="설문·참여 포스터" loading="lazy" style="display:block;width:100%;height:auto;border-radius:10px;border:1px solid var(--line);cursor:zoom-in;margin-bottom:11px"><div style="display:flex;flex-direction:column;gap:7px">'+LNK('#D8483A','집회','집회 참여 조사','1분','https://naver.me/Gpr2EXFj')+LNK('#3A6EA5','치료사','치료사 고용 피해','5분','https://naver.me/IgMhpn5i')+LNK('#0289A4','환자','환자 피해 조사','2분','https://naver.me/xF4Ex3F5')+LNK('#2E7D5A','카페','카페 가입','30초','https://cafe.naver.com/onpta')+'</div></div>';
