...
function renderRail(){
 ...
 var noticeRows=NN.length?NN.map(function(n,i){return '<a href="#" data-nav="notice" style="display:block;padding:9px 0'+(i<NN.length-1?';border-bottom:1px solid #f1efe9':'')+';text-decoration:none;color:inherit;font-size:12px;line-height:1.55">'
   +'<span style="font-weight:700;color:#1a1a1a">'+esc(n.date)+'</span> '
   +'<span style="color:#3a372f">'+esc(n.title).split('\\n').join('<br>')+'</span></a>';}).join(''):'';
 var yt=DATA.youtube;
